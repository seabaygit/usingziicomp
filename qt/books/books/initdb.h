...
QSqlError initDb()
{
    ...
    addBook(q, QLatin1String("Biological Structures Which Can AMPLIFY Pulsed-Microwave  Voice to Skull  Signals"), 2010, linId, science, 4,QLatin1String("This book helps to underestand the non-ionizing radiation and let us know how they can damage too.</b></font>"
