...
void addBook(QSqlQuery &q, const QString &title, int year, const QVariant &authorId,
             const QVariant &genreId, int rating, const QString &memo, const QString &testimony)
{
...
QSqlError initDb()
{
    ...
    db.setDatabaseName("dataphone.db.SQLite");
    ...
    QSqlQuery q;
    if (!q.exec(QLatin1String("create table books(id integer primary key, title varchar, author integer, genre integer, year integer, rating integer, memo varchar, testimony varchar)")))
        return q.lastError();
    ...
    if (!q.prepare(QLatin1String("insert into books(title, year, author, genre, rating,memo,testimony) values(?, ?, ?, ?, ?,?,?)")))
        return q.lastError();
    addBook(q, QLatin1String("The Soft Cage"), 1951, parentiId, nofiction, 3,QLatin1String("The Soft Cage: Surveillance in America From Slavery to the War on Terror (2003), a study of surveillance and control in modern society"),QLatin1String("testimony"));
    addBook(q, QLatin1String("Tropic of Caos"), 1952, parentiId, nofiction, 4,QLatin1String("Climate Change and the New Geography of Violence (2011)"),QLatin1String("testimony"));
    addBook(q, QLatin1String("Angler"), 2009, gellmanId, nofiction, 3, QLatin1String("No comments. Self explanatory"),QLatin1String("" ));
    addBook(q, QLatin1String("Foundation's Edge"), 1982, asimovId, sfiction, 3,QLatin1String("Sometimes those who are supposed to help you are in collussion with those who want to destroy you."),QLatin1String("testimony"));
    addBook(q, QLatin1String("Forward the Foundation"), 1993, asimovId, sfiction, 3,QLatin1String("I read very good books in this country"),QLatin1String("testimony"));
    addBook(q, QLatin1String("The Human Factor"), 1940, greeneId, fiction, 4,QLatin1String("This is a unique book, and a must for all those who want to know what really happens in the human heart"),QLatin1String("testimony"));
    addBook(q, QLatin1String("The Honorary Consul"), 1950, greeneId, fiction, 5,QLatin1String("Did not have too much time to read about history, but Eisenhower, Jefferson and Wallace made a lot of sense to me. They seemed to reflect the best moments of deep thought in this country. Remember, I did not read everything"),QLatin1String("testimony"));
    addBook(q, QLatin1String("Our Man in Havana"), 1958, greeneId, fiction, 4,QLatin1String("Very good book in a very complicated city" ),QLatin1String(" "));
    addBook(q, QLatin1String("Against All Enemies"), 1989, clarkeId, nofiction, 3,QLatin1String("An excellent book. It was the only book missing when my luggage was sent home in Canada. They had retained the luggage for several days after my arrival. Another book that I had was the Al Gore's book about Climate Change and another one that I do not want to mention here. "
                                                                                                "<br><b><font size=4> I believe that these books, plus the media that I used to analyze, were the main reason of me being targeted.</font></b>"),QLatin1String("testimony"));
    addBook(q, QLatin1String("Peacepink.ning.com"), 1951, solemavisId, nofiction, 3,QLatin1String("A website tht describes the use of Mind Control techniques allover the world. <b><font size = 4> It is a must for those who want to understand the evolution of technology and its application in attacks in the XXI Century </b></font>"),QLatin1String("testimony"));
    addBook(q, QLatin1String("Virtual Data"), 1951, julvegId, nofiction, 3,QLatin1String("A combination of documents and website about different techniques of Mind Control and how they are used to affect the Human Behavior <font size = 3 > <b> A must for those who want to understand how some are taking advantage of undisclosed technologies and old rules to destroy people and minds.</b></font>"
                                                                                        "<br>Check http://peacepink.ning.com/profile/julveg and shoppersworld.ueuo.com"),QLatin1String("testimony"));
    addBook(q, QLatin1String("Modern Thermodynamics"), 2010, jitaoId, science, 3,QLatin1String("This the book can be used as a textbook in universities and colleges for the modernization of the discipline of thermodynamics .<font size = 4 > <b> Based on the author's experiences, the modernization of the thermodynamics discipline is not easy, so the book is written in three levels.</b></font>"
                                                                                             "<br><b>The third level is the detailed-discussions in other parts of the whole the book.</b>"),QLatin1String("testimony"));
    addBook(q, QLatin1String("Intrusive Brain Reading Surveillance Technology: Hacking the Mind"), 2010, smithId, science, 4,QLatin1String("Theory, computation and numerical simulation.<font size = 4 > <b>Carole Smith describes claims that neuroscientists are developing brain scans that can read people’s intentions in the absence of serious discussions about the ethical issues this raises.</b></font>"),QLatin1String("testimony"));
    ...
    addBook(q, QLatin1String("Fluid Dynamics"), 2010, pozikrId, science, 4,QLatin1String("Theory, computation and numerical simulation.<font size = 4 > <b>This is the only available book that extends the classical field of fluid dynamics into the realm of scientific computing in a way that is both comprehensive and accessible to the beginner .</b></font>"
                                                                                         "<br>A must for practitioners and students in all fields of engineering, computational physics, scientific computing, and applied mathematics."),QLatin1String("testimony"));
    ...
    addBook(q, QLatin1String("Nuclear Physics B"), 2010, variousId, science, 4,QLatin1String("Nuclear Physics B focuses on the domain of high energy physics and quantum field theory.<font size = 4 > <b>.. particle physics (including particle physics; cosmology, astrophysics and gravitation; the physics of hadrons; computer simulations in physics; methods in theoretical physics), field theory and statistical systems and physical mathematics</b></font>"
                                                                                             "<br>The emphasis is on original research papers.."),QLatin1String("testimony"));
    ...
    addBook(q, QLatin1String("Conspiracy of Fools"), 2010, whiteId, website, 4,QLatin1String("<b>This is a very well documented website that provides important scientific information about what is done in the field of harassment and attacks.<font size = 4 > <b>..</b></font>"
                                                                                             "<br>It is very well focused in real information. There are no hypothesis here"),QLatin1String("testimony"));
    ...
    addBook(q, QLatin1String("www.raven1.net"),2010, whiteId, science, 4,QLatin1String("Excelent Website.<font size = 4 > <b>Provides a lot of scientific information about numerous techniques of attack</b></font>"
                                                                                             "<br>The quality of information of this website is very difficult to match"),QLatin1String("testimony"));
    addBook(q, QLatin1String("Aerial Mind-Control The Threat to Civil Liberties"), 2010, wallId, science, 4,QLatin1String("Hard hitting article by Judy Wall, who is NOT a mind control"
                                       "victim and in fact avoids victim testimonials in favour of only factual objective material.</b></font>"
                                                                                             "<br>NEXUS Magazine, October-November 1999"),QLatin1String("testimony"));
    addBook(q, QLatin1String("Biological Structures Which Can AMPLIFY Pulsed-Microwave  Voice to Skull  Signals"), 2010, linId, science, 4,QLatin1String("<b><font>This book helps to underestand the non-ionizing radiation and let us know how they can damage too.</b></font>"
                            "<br>It is one of the first and best documented books on the subject.."),QLatin1String("testimony"));
    ...
    addBook(q, QLatin1String("Intrusive Brain Reading Surveillance Technology: Hacking the Mind"), 2010, smithId, science, 4,QLatin1String("Carole Smith describes claims that neuroscientists are developing brain scans that can read people’s intentions in the absence of serious discussions about the ethical issues this raises"
                                                                                                                                           ".</b></font>"),QLatin1String("testimony"));
    ...
    " abnormalities, sterility, birth defects, and genetic mutations which could be passed on from generation to generation.</b></font>"),QLatin1String("testimony"));
    ...
    "It is desired that no document be released which refers to experiments with humans and might have adverse effect on public opinion or result in legal suits"),QLatin1String("testimony"));
