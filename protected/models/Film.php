 ...
 * @property string $type_of_film
 * @property string $introduction_context
 * @property string $description
 * @property string $special_memo
...
class Film extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('title, type_of_film, introduction_context, language_id, last_update', 'required'),
			array('language_id, original_language_id, rental_duration, length', 'numerical', 'integerOnly'=>true),
			array('title', 'length', 'max'=>255),
			array('type_of_film', 'length', 'max'=>20),
			array('special_memo', 'length', 'max'=>400),
			...
			array('film_id, title, type_of_film, introduction_context, description, special_memo, release_year, language_id, original_language_id, rental_duration, rental_rate, length, replacement_cost, rating, special_features, last_update', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('type_of_film',$this->type_of_film,true);
		$criteria->compare('introduction_context',$this->introduction_context,true);
		$criteria->compare('description',$this->description,true);
		$criteria->compare('special_memo',$this->special_memo,true);
