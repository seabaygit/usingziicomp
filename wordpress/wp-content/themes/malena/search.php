...
<div id="pages">
  ...
  <div id="columns">
    <div id="centercol">
        ...
        <div class="content">
          <div class="post-commets"><?php comments_popup_link('0', '1', '%'); ?></div>
          <!--/post-commets -->
          ...
          <!--/post-title -->
          <div class="post-date">
            <div><span> On <?php the_time('d S'); ?> <?php the_time('M Y'); ?>, In <?php the_category(', '); ?> , by <?php the_author_posts_link(); ?><?php if (current_user_can('edit_post', $post->ID)) { ?> , <?php edit_post_link('Edit', '', ''); } ?></div>
            <div class="clr"></div>
          </div>
          <!--/social-links -->
          <div class="clr"></div>
          <div class="pic">
          <a href="<?php the_permalink();?>"><img src="<?php echo get_post_meta($post->ID, 'thumbnail', true);?>" alt="Post Pic" width="581" height="129" /></a>
          </div>
          <!--/post-pic -->
          <div class="clr"></div>
          <div class="post-excerpt">
            <p><?php the_excerpt(); ?></p>
            <p><span><a href="<?php the_permalink() ?>" rel="bookmark" title="Read more about <?php the_title(); ?>">Readmore &raquo;</a></span></p>
          <div class="clr"></div>
          </div>
          <!--/post-excerpt -->
          <div class="clr"></div>
