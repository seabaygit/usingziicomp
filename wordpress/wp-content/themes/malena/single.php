  ...
  <div id="columns">
    <div id="centercol">
        ...
        <div class="content">
          ...
          <div class="clr"></div>
          <div class="pic">
          <a href="<?php the_permalink();?>"><img src="<?php echo get_post_meta($post->ID, 'thumbnail', true);?>" alt="Post Pic" width="581" height="250" /></a>
          </div>
          <!--/post-pic -->
          <div class="clr"></div>
      ...
      <!--/box -->
                            <div class="comment" style="color:#000;margin-left:10px;font-size:16px;"><?php comments_template( '', true ); ?></div>
                 <?php endwhile; ?>
	       <?php endif; ?>
      <div class="clr"></div>
