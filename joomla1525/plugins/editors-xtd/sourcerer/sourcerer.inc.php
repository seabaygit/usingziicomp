...
class plgButtonSourcererPopup
{
	function render(&$params)
	{
		...
		$params->code = $params->example_code_free;
				...
				<div class="button2-left">
					<div class="blank">
						<label class="hasTip"
							...
							<a rel="" onclick="eAL.toggle( 'source' );return false;"
								href="javascript://;"><?php echo JText::_('SRC_TOGGLE_EDITOR') ?></a>
						</label>
					</div>
				</div>
				<div class="button2-left">
					<div class="blank hasicon sourcetags_0" id="sourcetags_button">
						<label class="hasTip"
							...
							<a rel="" onclick="sourcerer_toggleSourceTags();return false;"
								href="javascript://;"><?php echo JText::_('SRC_TOGGLE_SOURCE_TAGS') ?></a>
						</label>
					</div>
				</div>
				<div class="button2-left">
					<div class="blank hasicon tagstyle_0" id="tagstyle_button">
						<label class="hasTip"
							...
							<a rel="" onclick="sourcerer_toggleTagStyle();return false;"
								href="javascript://;"><?php echo JText::_('SRC_TOGGLE_TAG_STYLE') ?></a>
						</label>
					</div>
				</div>
